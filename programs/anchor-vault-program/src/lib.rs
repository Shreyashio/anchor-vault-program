use anchor_lang::{accounts::signer, prelude::*, system_program::{self, Transfer, transfer}};
...
impl<'info> Deposit<'info>{
    pub fn deposit(&mut self, amount: u64) -> Result<()> {
        ...
        self.vault_state.state_bump = self.vault_state.state_bump;
        self.vault_state.vault_bump = self.vault_state.vault_bump;
